...
function sideBar() {
  ...
  return (
    <div>
        {/* sidebar */}
        <aside className="w-64 h-screen bg-gradient-to-br from-[#76C893] to-[#1E6091] text-white flex flex-col items-center py-4 shadow-md">
          ...
          {icons.map((icon) => (
            <div
              ...
              className={`
                  sidebar-icon text-2xl mb-6 w-56 justify-center flex cursor-pointer transition-all duration-300 ease-in-out
                  ${active === icon.name
